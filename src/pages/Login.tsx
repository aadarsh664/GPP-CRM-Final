...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6">
      ...
      <div className="w-full max-w-sm border border-gray-300 rounded-2xl p-6 shadow-sm">
      ...
      <div className="mt-8 border border-gray-300 rounded-md p-3 flex items-center justify-between w-full max-w-sm">
